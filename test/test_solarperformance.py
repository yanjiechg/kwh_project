...
class TestSolarPerformance(unittest.TestCase):
    ...
    def test_name(self):
        ...
        self.assertEqual(instance.givename(), self.name)
    ...
    def test_nonexistantname(self):
        ...
        self.assertRaises(NameError, SolarPerformance, 'Silly Name')

    def test_sqlinjection(self):
        """
        Class should not be fooled by tricky sqlinjection
        """
        bad_name = "'; drop table systems; --"
        self.assertRaises(NameError, SolarPerformance, bad_name)
